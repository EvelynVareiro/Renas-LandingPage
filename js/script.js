...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const closeButtons = [...document.querySelectorAll('[data-dish-modal-close]')];
  const fields = {
  ...
  const openModal = id => {
    ...
    const visibleCloseButton = closeButtons.find(button => getComputedStyle(button).display !== 'none');
